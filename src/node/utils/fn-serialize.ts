...
export function deserializeFunctions(value: any): any {
  ...
  } else if (typeof value === 'string' && value.startsWith('_stone-fn_')) {
...
export const deserializeFunctions =
  'function deserializeFunctions(r){return Array.isArray(r)?r.map(deserializeFunctions):typeof r=="object"&&r!==null?Object.keys(r).reduce((t,n)=>(t[n]=deserializeFunctions(r[n]),t),{}):typeof r=="string"&&r.startsWith("_stone-fn_")?new Function(`return ${r.slice(7)}`)():r}';
